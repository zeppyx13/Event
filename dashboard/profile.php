        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a class="btn btn-outline-primary btn-sm mb-0 me-3">10-DESEMBER-2023</a>
            </li>
              ...
              <div class="card-body p-3">
                <form action="" method="post" role="form" class="text-start" enctype="multipart/form-data">
                  <div class="row">
                    ...
                    <div class="col-6">
                      <div class="input-group input-group-outline my-3">
                        <input accept=".IMG,.JPG,.JPEG,.HEIC,.PNG," autocomplete="off" name="img" type="file" name="gbr" class="form-control">
                      </div>
                    </div>
                    <div class="card-header pb-0 p-3">
