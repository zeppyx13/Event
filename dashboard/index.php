...
$bayar = query("SELECT SUM(bayar) AS TotalB FROM hutang WHERE Id_user = '$id_user'")[0];
$hutang = query("SELECT SUM(hutang) AS TotalP FROM hutang WHERE Id_user = '$id_user'")[0];
$season = query("SELECT * FROM deadline ORDER BY season DESC")[0];
$query = query("SELECT * FROM hutang INNER JOIN lokasi ON lokasi.Id_lokasi  = hutang.Id_tempat WHERE Id_user  = '$id_user'");
//
                      ...
                      <tr>
                        ...
                        <?php if ($row['bukti'] != NULL) { ?>
                          <td class="text-center text-black">
                            <a target="_blank" href="../assets/bukti/<?= $row['bukti'] ?>">Bukti</a>
                          </td>
                        <?php } else { ?>
