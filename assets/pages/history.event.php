                                ...
                                <table class="table align-items-center mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center text-uppercase text-black font-weight-bolder">Kegiatan</th>
                                            <th class="text-center text-uppercase text-black font-weight-bolder">Lokasi</th>
                                            <th class="text-center text-uppercase text-black font-weight-bolder">Daerah</th>
                                            <th class="text-center text-uppercase text-black font-weight-bolder">Tanggal</th>
                                            <th class="text-center text-uppercase text-black font-weight-bolder">Waktu</th>
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($query as $row) : ?>
                                            <tr>
                                                ...
                                                <td class="text-center text-black"><?= $row['Kegiatan'] ?></td>
                                                <td class="text-center text-black"><?= $row['Lokasi'] ?></td>
                                                <td class="text-center text-black"><?= $row['Daerah'] ?></td>
                                                <td class="text-center text-black"><?= $row['tanggal'] ?></td>
                                                <td class="text-center text-black"><?= $row['waktu'] ?></td>
