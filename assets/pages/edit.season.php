...
if (isset($_POST['add'])) {
    if (editseason($_POST) > 0) {
        echo "<script>
      alert('season di rubah');
...
$id = $_GET['id'];
$query = query("SELECT * FROM deadline WHERE id = $id")[0];
?>
<!DOCTYPE html>
<html lang="id">
                        ...
                        <form action="" class="mb-5" method="post" id="contactForm" enctype="multipart/form-data">
                            <div class=" row">
                                <div class="col-md-12 form-group mb-3">
                                    <input type="text" name="id" class="d-none" value="<?= $query['id'] ?>">
                                    <label for="nama" class="col-form-label">Season ke- :</label>
                                    <input value="<?= $query['season'] ?>" required autocomplete="off" id="nama" class="form-control" type="number" name="season" placeholder="Masukan Season sekarang">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4 form-group mt-4 mb-4">
                                    <label for="tgl" class="col-form-label">Tanggal :</label>
                                    <input value="<?= $query['tanggal'] ?>" required autocomplete="off" type="Number" class="form-control" name="tgl" id="tgl">
                                </div>
                                <div class="col-md-4 form-group mt-4 mb-4">
                                ...
                                <div class="col-md-4 form-group mt-4 mb-4">
                                    ...
                                    <input value="<?= $query['tahun'] ?>" required autocomplete="off" type="number" class="form-control" name="tahun" id="tahun">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 form-group mt-4 mb-4">
                                    <input type="submit" name="add" value="Edit Season" class="btn btn-primary rounded-0 py-2 px-4">
