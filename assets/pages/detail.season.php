...
error_reporting(0);
$id = $_GET['id_folder'];
$query = query("SELECT * FROM deadline");
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">Detail Season</h6>
                </nav>
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">SEASON<a class="text-white text-capitalize" style="margin-left:80%" href="../../admin/profile.php">BACK</a></h6>
                            </div>
                        </div>
                                ...
                                <table class="table align-items-center mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center text-black font-weight-bolder">season</th>
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($query as $row) : ?>
                                            <tr>
                                                ...
                                                <td class="text-center text-black"><?= $row['season'] ?></td>
                                                <td class="text-center text-black"><?= $row['tanggal'] ?>-<?= $row['bulan'] ?>-<?= $row['tahun'] ?></td>
