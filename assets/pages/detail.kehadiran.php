                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Kehadiran Di <?= $lokasi['Lokasi'] ?><a class="text-white text-capitalize" style="margin-left:80%" href="./history.event.php">BACK</a></h6>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($query as $row) : ?>
                                            <tr>
                                                ...
                                                <td class="text-center text-black"><?= $row['kehadiran'] ?></td>
                                            </tr>
                                            <?php $i++; ?>
                                        <?php endforeach; ?>
                                    </tbody>
